...
urlpatterns = [
    ...
    path('owner/', HospitalListView.as_view(),
         name='owner'),
    ...
    path('doctors/', DoctorsListView.as_view(),
         name='doctors'),
    path('doctors/create/', DoctorsCreateView.as_view(),
         name='doctors-create'),
    path('receptionists/', ReceptionistsListView.as_view(),
         name='receptionists'),
    path('receptionits/create/', ReceptionistsCreateView.as_view(),
         name='receptionits-create'),
